              ...
              <div id = "cardtabel" class="card">
                <div class="card-header">
									<div class="row">
										...
										<div class = "col-lg-2 icon-custom-table-header"><a href="<?php echo base_url('m_schedule/add');?>"><i class="fa fa-plus"></i> <?php echo $resource['res_add']?></a></div>
									</div>
								</div>
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-hover">
                      <thead>
                        <tr>
                          <th><?php echo  $resource['res_day']?></th>
                          <th><?php echo  $resource['res_time']?></th>
                          <th><?php echo  $resource['res_subject']?></th>
                          <th><?php echo  $resource['res_class']?></th>
                          <th><?php echo  $resource['res_teacher']?></th>
                          <th></th>
                        </tr>
                      </thead>
                      <tbody>
											...
											?>
													<tr>
                            <td><?php echo getEnumName("Days", $value->Hari)?></td>
                            <td><?php echo $value->JamMulai.' - '.$value->JamAkhir?></td>
                            ...
                            <td><?php echo $value->Name?></td>
														<td class = "icon-custom-table-header">
															...
															<a class = "icon-custom-table-detail" href="javascript:void(0);" onclick="delete_disaster('<?php echo $value->Id?>','<?php echo $value->Hari?>')"><i class="fa fa-trash"></i><?php echo  $resource['res_delete']?></a>
														</td>
													</tr>
											<?php
												}
                    ...
                    <div class = "col-lg-6 ">
                      <nav aria-label="Page navigation example ">
                        <ul class="pagination">
                          ...
                          ?>
                          <li class="page-item">
                            <a class="page-link" href="<?php echo base_url('m_schedule');?>?page=<?php echo $currentpage-1?>&search=<?php echo $search?>#cardtabel" aria-label="Previous">
