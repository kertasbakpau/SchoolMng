    ...
    <div class="breadcrumb-holder">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form method = "post" action = "<?php echo base_url('mworker/editsave');?>">
 
                    <input hidden = "true" name="idworker" value="<?php echo $model['id']?>"/> 
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input readonly id = "name" placeholder="<?php echo $resource['res_classid']?>" type="text" class="form-control"  value="<?php echo $model['classid']?>">
                        ...
                        <div class="col">
                          ...
                          <input id="nip" type="text" placeholder="<?php echo $resource['res_nip']?>" class="form-control" name = "nip" value="<?php echo $model['nip']?>">
                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col">
                          ...
                          <div>
                             <input id="telephone" type="text" placeholder="<?php echo $resource['res_telephone']?>" class="form-control" name = "telephone" value="<?php echo $model['telephone']?>">                        </div>
                        </div>
                        <div class="col">
      ...
      <script type = "text/javascript">
        $(document).ready(function() {    
         init();
         console.log("<?php echo $model['gender']?>");
         $("#gender").val("<?php echo $model['gender']?>");
         $("#religion").val("<?php echo $model['religion']?>");
         $("#worker_status").val("<?php echo $model['worker_status']?>");
        });
