              ...
              <div id = "cardtabel" class="card">
                <div class="card-header">
									<div class="row">
										...
										<div class = "col-lg-2 icon-custom-table-header"><a href="<?php echo base_url('mschoolyear/add');?>"><i class="fa fa-plus"></i> <?php echo $resource['res_add']?></a></div>
									</div>
								</div>
                <div class="card-body">
                    ...
                    <div class = "col-lg-10 ">
                      <nav aria-label="Page navigation example ">
                        <ul class="pagination">
                          ...
                          ?>
                          <li class="page-item">
                            <a class="page-link" href="<?php echo base_url('m_schoolyear');?>?page=<?php echo $currentpage-1?>&search=<?php echo $search?>#cardtabel" aria-label="Previous">
                          ...
                          ?>
                            ...
                            ?>
                              <li class="page-item">
                                <a class="page-link" href="<?php echo base_url('m_schoolyear');?>?page=<?php echo $i?>&search=<?php echo $search?>#cardtabel"><?php echo $i?></a>
                              </li>
                            <?php
                            }
                            ?>
                          ...
                          ?>
                          <li class="page-item">
                            <a class="page-link" href="<?php echo base_url('m_schoolyear');?>?page=<?php echo $currentpage+1?>&search=<?php echo $search?>#cardtabel" aria-label="Next">
...
<script type = "text/javascript">
  ...
  $("#searchbutton").on("click",function() {
    ...
    //alert(search);
    window.location =" <?php echo base_url('m_schoolyear');?>?search="+search;
  })   

  function delete_schoolyear(id, name){
    deleteData(name, function(result){
      if (result==true)
        window.location = "<?php echo base_url('mschoolyear/delete/');?>" + id;
    });
  } 
  function activate_schoolyear(id){
    window.location = "<?php echo base_url('mschoolyear/activate/');?>" + id;
  }
</script>
