        ...
        <div class="container-fluid">
          ...
          <header class = "header-custom"> 
            <h1 class="h3 display"><i class="fa fa-fire"></i>
              <?php 
               echo $resource['res_master_school']
              ?></h1>
          </header>
          <div class="row">
            <div class="col-lg-12">
              <div id = "cardtabel" class="card">
                <div class="card-header">
									<div class="row">
										...
										<div class = "col-lg-2 icon-custom-table-header"><a href="<?php echo base_url('m_school/add');?>"><i class="fa fa-plus"></i> <?php echo $resource['res_add']?></a></div>
									</div>
								</div>
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-hover">
                      <thead>
                        <tr>
                          <th><?php echo  $resource['res_school_name']?></th>
                          <th><?php echo  $resource['res_addres']?></th>
                          <th></th>
                        </tr>
                      </thead>
                      <tbody>
                              ...
                              <a class = "icon-custom-table-detail" href="<?php echo base_url('m_school/hapus/').$value->Id;?>"><i class="fa fa-trash"></i><?php echo  $resource['res_delete']?></a>
                            </td>
													</tr>
											<?php
												}
