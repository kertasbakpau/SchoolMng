            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                    ...
                    </div><div class = "col-lg-2 icon-custom-table-header"><a href="<?php echo base_url('m_school');?>"><i class="fa fa-table"></i> Index</a></div>
                  </div>
                </div>
                <div class="card-body">
                  <form method = "post" action = "<?php echo base_url('m_school/editsave');?>">
                    ...
                    <div class="form-group">
                      ...
                      <input id="named" type="text" placeholder="<?php echo $resource['res_name']?>" class="form-control" name = "named" value="<?php echo $model['namasekolah']?>" required>
                    </div>
                    <div class="form-group">       
